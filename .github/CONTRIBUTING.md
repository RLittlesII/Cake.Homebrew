# How to contribute
Contributions to Cake.Homebrew are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
We want to know what you think is missing from Cake.Homebrew and how it can be made better.
...
* To quickly create a topic branch based on dev; `git checkout -b my_contribution dev`. Please avoid working directly on the `dev` or `master` branch.
...
* Once the pull request has been reviewed and accepted, it will be merged with the dev branch.
* Celebrate
